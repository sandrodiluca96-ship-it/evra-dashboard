...
with tabs[5]:
    ...
    if filtered_acq.empty:
        ...
        if fornitori:
            ...
            fig = px.line(fm, x="Mese_Nome", y=f"{met_f}_Cumulato", color="Anno", markers=True, category_orders={"Mese_Nome":MONTH_ORDER}, title=f"Cumulativo fornitore - {fornitore}", custom_data=["Anno","N_Articoli", met_f])
...
with tabs[6]:
    ...
    if filtered_ven.empty:
        ...
        if clienti:
            ...
            fig = px.line(cm, x="Mese_Nome", y=f"{met_c}_Cumulato", color="Anno", markers=True, category_orders={"Mese_Nome":MONTH_ORDER}, title=f"Cumulativo cliente - {cliente}", custom_data=["Anno","N_Codici", met_c])
